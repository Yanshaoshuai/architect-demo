...
public class StringTools {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(filterChinese("ces测试--.jpg"));
    ...
    /**
     * 字符串转换为Map对象
     * @param mapStr 待转换字符串,eg. aaa=111,bbb=222
     * @return Map对象
     */
     ...
     * <p>
     * <B>注意:</B>请使用toHexTable(byte[] data, int numOfLine, int column,String charset)方法,谢谢.
     *
     * @param data
     *            字节数组
     * @param column
     *            输出内容:7是左中右都会输出,4只输出最左边,2只输出中间部分,1只输出最右边
     * @return 转化后的16进制表格字符串
     */
     ...
     * <DT><B>split </B></DT>
     * <p>
     * <DD>因为 <code>String.split(String)</code> 在jdk1.4之前的版本中没有,所以提供这个方法。使用 <code>StringTokenizer</code>
     * 实现。所以,把空的段都给过滤掉了。如果需要空的段,可以使用 <code>splitEx(String, char)</code> 方法。</DD>
     * </DL>
     * <p>
     *
     * @param source
