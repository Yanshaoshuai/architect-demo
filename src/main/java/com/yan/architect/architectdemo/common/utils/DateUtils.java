...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
     ...
     *            java.sql.Timestamp instance
     * @param sFmt
     *            Date 格式，DATE_FORMAT_DATEONLY/DATE_FORMAT_DATETIME/ DATE_FORMAT_SESSION
     * @return
     * @since 1.0
     * @history
     */
    ...
    public static String getTimeToApp(Date date) {
        ...
        if (second < 60) {
            ...
            if (second % 3600 == 0) {
                ...
                min = String.valueOf(second / 60 % 60) + "分钟前";
            }
            return String.valueOf(second / 3600) + "小时" + min;
    ...
    public static String getAnHourOfTime(String time) {
        Calendar c = Calendar.getInstance();
        Date date =DateUtils.StringToDate(time, "yyyy-MM-dd HH:mm:ss");
        c.setTime(date);
        c.set(Calendar.HOUR_OF_DAY, c.get(Calendar.HOUR_OF_DAY) - 1);
        String dateStr = DateUtils.getTimeStampStr(c.getTime());
        return dateStr;
    }
